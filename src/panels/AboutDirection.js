        ...
        return (
            <Panel id={this.props.id}>
                ...
                <FixedLayout filled vertical="bottom">
                    ...
                    <Link style={{width: '100%', textAlign: 'center', color:"var(--button_primary_foreground)", background:"var(--button_primary_background)", borderRadius:8, minHeight:44, display: "flex", justifyContent: "center", alignItems: "center", fontWeight:"500"}} href={this.state.interestedDirection['Подробнее']} target="_blank"> Подробнее</Link>
                    </Div>
                </FixedLayout>
            </Panel>
        )
